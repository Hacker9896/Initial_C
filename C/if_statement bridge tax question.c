...
Crossing the bridge is not free - the bridgekeeper asks you to roll two dice to determine
the cost. You decide to write a program to verify that he is charging the right price.
...
Otherwise, you pay twice the sum of the values of the two dice. Your program must then display
